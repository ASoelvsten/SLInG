...
(B) edge [bend right, -Stealth,color=teal] (A)
(EB) edge [-Stealth, color=teal] (B)
(A) edge [bend right, -Stealth,color=teal] (C)
(B) edge [bend right, -Stealth,color=teal] (C)
;
%Repression:
...
(A) edge [bend right, -Circle,color=purple] (B)
(EC) edge [-Circle,color=purple] (C)
;
\end{tikzpicture}
\end{document}
